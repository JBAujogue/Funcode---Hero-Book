...
#                      main script                        *
#**********************************************************
st.set_page_config(page_title = 'Hero Book Solver', layout = 'wide')
st.title('Hero Book Solver')
st.write(' ')
st.write(' ')
...
if st.session_state.nx_graph is not None:
	...
	with col_graph:
		...
		nx_graph = nx.ego_graph(nx_graph, n = source, radius = radius)
		nt_graph = convert_nx_to_nt_graph(nx_graph, node_colors = {source: '#fa624b'})
